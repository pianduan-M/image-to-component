...
export const formItemTpl = `<el-form-item label="$label" prop="$prop" >\n$children\n</el-form-item>`;
...
export const dateTpl = `<el-date-picker v-model="formData.$prop" type="date" placeholder="请选择时间" ></el-date-picker>`;
